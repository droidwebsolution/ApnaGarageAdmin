            ...
            if($count_po>0){ 
                ...
                if($ac_amt < $ag_po_cust_pay){}else{
                    ...
                    if($pos_up->execute()){
                        ...
                        $add_data="insert into ag_po_cart_repo(ag_po_invoice_no,ag_retailer_name,ag_retailer_company_phone,ag_retailer_company_email,ag_retailer_company_gst,ag_retailer_company_tin,ag_retailer_state,ag_retailer_city,ag_retailer_area,ag_retailer_house_no,ag_retailer_pincode,ag_po_payment_type,ag_po_receipt_no,ag_po_amount_paid,ag_po_pending_amt,ag_po_cust_pay,ag_po_invoice_date,ag_po_invoice_due_date,ag_po_receipt_img,ag_no_of_items,ag_po_cart_repo_status)values(:ag_po_invoice_no,:ag_retailer_name,:ag_retailer_company_phone,:ag_retailer_company_email,:ag_retailer_company_gst,:ag_retailer_company_tin,:ag_retailer_state,:ag_retailer_city,:ag_retailer_area,:ag_retailer_house_no,:ag_retailer_pincode,:ag_po_payment_type,:ag_po_receipt_no,:ag_po_amount_paid,:ag_po_pending_amt,:ag_po_cust_pay,:ag_po_invoice_date,:ag_po_invoice_due_date,:ag_po_receipt_img,:ag_no_of_items,:ag_po_cart_repo_status)";
