...
<html lang="en">
    <head>
        ...
        <title>Apna garage | Purchase Order Report</title>
    ...
    <body>
        ...
        <div id='container'>
            <div class='search_filter'>
                <input type='text' class='search_input by_name' title='Search By Part Name' onkeyup='get_parts()' placeholder='Search By Part Name' />
...
<script>
    ...
    function get_parts() {
        ...
        var to_date = $('.to_date').val();
             $.ajax({
            url: 'assets/purchase_report_jscript.php',
            method: 'post',
